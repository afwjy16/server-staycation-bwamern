...
module.exports = {
  landingPage: async (req, res) => {
    try {
      ...
      const testimonial = {
        _id: "asd1293uasdads1",
        imageUrl: "images/stories1-hero.jpg",
        name: "Happy Family",
        rate: 4.55,
        content:
  ...
  detailPage: async (req, res) => {
    try {
      ...
      const testimonial = {
        _id: "asd1293uasdads1",
        imageUrl: "images/stories2-hero.jpg",
        name: "Happy Family",
        rate: 4.55,
        content:
          "What a great trip with my family and I should try again next time soon ...",
  ...
  bookingPage: async (req, res) => {
    try {
      ...
      if (
        ...
        return res.status(404).json({ message: "Complete your field!" });
      }
      ...
      const invoice = Math.floor(1000000 + Math.random() * 9000000); //create random no. invoice
